...
function Navbar() {
    ...
    const downloadHandle = () => {
        ...
        link.click();
        window.open(
            "https://drive.google.com/file/d/1xXQ5Iz16xwziy5cISKtZVRM8_aIk89h8/view?usp=sharing",
            "_blank"
        );
    };
        ...
        <>
            <div id='nav-menu'>
                ...
                <div id="largeScreenNavbar">
                    <a href='#home'><h2>{"Mridul Katara"}</h2></a>
                    ...
                    <div>
                        ...
                        <a href="https://github.com/MridulKatara" target="_blank" className="nav-link github">
                            GitHub
                        </a>
                    </div>
                </div>
            ...
            </div >
            {
                burger ? (<div id='smallScreenDropDown' >
                    <div>
                        ...
                        <a href="https://github.com/MridulKatara" target="_blank" className="nav-link github" style={{ margin: "auto", width: "100px" }}
